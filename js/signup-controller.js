...
BookIt.SignUpController.prototype.init = function () {
    ...
    this.$txtJobTitle = $("#txt-job-title", this.$signUpPage);
    this.$txtDepart = $("#txt-depart", this.$signUpPage);
};
...
BookIt.SignUpController.prototype.resetSignUpForm = function () {
    ...
    this.$txtJobTitle.removeClass(invalidInputStyle);
    this.$txtDepart.removeClass(invalidInputStyle);
...
BookIt.SignUpController.prototype.onSignupCommand = function () {
    ...
    var me = this,
        ...
        dob = me.$txtDob.val(),
        jobTitle = me.$txtJobTitle.val().trim(),
        depart = me.$txtDepart.val().trim(),
        invalidInput = false,
    ...
    me.$txtJobTitle.removeClass(invalidInputStyle);
    me.$txtDepart.removeClass(invalidInputStyle);
    ...
    if(jobTitle == '') {
    	me.$txtJobTitle.addClass(invalidInputStyle);
        invalidInput = true;
    }
    
    if(depart == '') {
    	me.$txtDepart.addClass(invalidInputStyle);
        invalidInput = true;
    }
    ...
    $.ajax({
        ...
        data:"email=" + emailAddress + "&first_name=" + firstName + "&last_name=" + lastName + "&password=" + password + "&passwordConfirm=" + passwordConfirm + "&age=" + age +"&dob=" + dob + "&job_title=" + jobTitle + "&departements="+ depart,
        cache: false,
