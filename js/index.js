...
app.searchClaimsController = new BookIt.searchClaimsController();

app.forgotPasswordController = new BookIt.forgotPasswordController();
...
$(document).delegate("#forgot-password", "pagebeforecreate", function () {
    app.forgotPasswordController.init();
    app.forgotPasswordController.$btnForgot.off("tap").on("tap", function () {
        app.forgotPasswordController.onForgotCommand();
    });
    app.forgotPasswordController.$btnReset.off("tap").on("tap", function () {
        app.forgotPasswordController.onResetCommand();
    });
});

$(document).delegate("#page-manage", "pagebeforecreate", function () {
    app.searchClaimsController.init();
	app.searchClaimsController.$btnAmount.off("tap").on("tap", function () {
		app.searchClaimsController.amount();
	});
	app.searchClaimsController.$btnDate.off("tap").on("tap", function () {
		app.searchClaimsController.date();
	});
});
